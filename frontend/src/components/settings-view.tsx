...
import { User, LogOut, Star, Radio, Shield, MapPin, History } from "lucide-react";
...
export function SettingsView() {
  ...
  useEffect(() => {
    axiosClient.get('/users/me/stats')
  ...
  const roleColor =
    stats?.role === 'MODERATOR' ? 'text-cyan-400' :
    stats?.role === 'ADMIN'     ? 'text-warning-amber' :
    'text-terminal-green';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-terminal-green/20 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-charcoal border-2 border-terminal-green flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-terminal-green font-mono mt-0.5">STATUS: ACTIVE</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-terminal-green/10">
            <div>
              ...
              <div className="text-sm text-white font-mono flex items-center gap-1">
                ...
                {statsLoading ? '—' : (stats?.sector != null ? `SECTOR ${stats.sector}` : 'UNASSIGNED')}
              </div>
            </div>

            <div>
              <div className="text-xs text-muted-foreground font-mono mb-1">REPUTATION</div>
              <div className={`text-sm font-mono flex items-center gap-1 ${statsLoading ? 'text-muted-foreground' : reputationColor(stats?.reputationScore ?? 0)}`}>
            ...
            <div>
              <div className="text-xs text-muted-foreground font-mono mb-1">SIGNALS SENT</div>
              <div className="text-sm text-white font-mono flex items-center gap-1">
            ...
            <div>
              <div className="text-xs text-muted-foreground font-mono mb-1">VERIFICATIONS</div>
              <div className="text-sm text-white font-mono flex items-center gap-1">
            ...
            <div>
              <div className="text-xs text-muted-foreground font-mono mb-1">TRUSTED SIGNALS</div>
      ...
      <div className="bg-card border border-terminal-green/20 p-6">
        ...
        <div className="text-center py-8">
          ...
          <div className="text-muted-foreground font-mono text-sm">NO TRADES YET</div>
