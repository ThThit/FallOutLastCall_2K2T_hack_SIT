  ...
  const alerts: Alert[] = [
    {
      ...
      message: 'All contact prohibited. Military enforcement active. Avoid all access points.',
      timestamp: '1h ago',
      sector: 'SECTOR 7',
      isRead: false,
    },
    {
      ...
      message: 'River district water supply tested positive for toxins. Use filtration systems only.',
      timestamp: '3h ago',
      sector: 'SECTOR 4',
      isRead: false,
    },
    {
      ...
      message: 'Medical supplies successfully delivered to northern checkpoint. Distribution begins 06:00.',
      timestamp: '5h ago',
      sector: 'SECTOR 1',
      isRead: true,
    },
    {
      ...
      message: 'Communication network will undergo maintenance from 02:00 to 04:00. Expect service interruption.',
      timestamp: '8h ago',
      isRead: true,
    },
    {
      ...
      message: 'Armed groups reported in eastern perimeter. Seek shelter immediately. Do not engage.',
      timestamp: '12h ago',
      sector: 'SECTOR 8',
      isRead: true,
    },
          ...
          return (
            <motion.div
              ...
              className={`bg-card border-l-4 ${config.border} p-4 ${
                !alert.isRead ? 'border-r border-t border-b ' + config.border : 'border border-terminal-green/10'
              }`}
            >
              <div className="flex items-start gap-4">
                <div className={`p-2 ${config.bg} ${!alert.isRead ? 'animate-pulse' : ''}`}>
