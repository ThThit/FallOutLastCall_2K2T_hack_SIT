...
INSERT INTO "new_Trade" ("category", "condition", "createdAt", "creatorId", "id", "location", "quantity", "requestedItem", "requestedQuantity", "resourceName", "status", "traderName", "updatedAt") SELECT "category", "condition", "createdAt", "creatorId", "id", "location", "quantity", "requestedItem", "requestedQuantity", "resourceName", "status", "traderName", "updatedAt" FROM "Trade";
DROP TABLE "Trade";
